...
export class RegisterPageLocators extends BaseLocator {
  ...
  readonly confirmPasswordInput: Locator =
    this.baseLocator.getByLabel(/confirm password/i);

  readonly companyNameInput: Locator =
    this.baseLocator.getByLabel(/company name/i);

  readonly phoneNumberInput: Locator =
    this.baseLocator.getByLabel(/phone number/i);

  readonly addressLineOneInput: Locator =
    this.baseLocator.getByLabel(/address line 1/i);

  readonly addressLineTwoInput: Locator =
    this.baseLocator.getByLabel(/address line 2/i);

  readonly suburbCityInput: Locator =
    this.baseLocator.getByLabel(/suburb\/city/i);

  readonly stateProvinceInput: Locator =
    this.baseLocator.getByLabel(/state\/province/i);

  readonly zipPostcodeInput: Locator =
    this.baseLocator.getByLabel(/zip\/postcode/i);
