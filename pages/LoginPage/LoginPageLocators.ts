...
export class LoginPageLocators extends BaseLocator {
  ...
  readonly emailRequiredNotification: Locator = this.emailInput.locator('..').locator('+ div');

  readonly passwordRequiredNotification: Locator = this.passwordInput
    .locator('..')
    .locator('+ div');

  readonly addressOrPasswordIsIncorrectNotification: Locator = this.loginButton.locator('+ div');
}
